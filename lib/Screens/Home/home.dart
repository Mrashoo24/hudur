                                ...
                                showDialog(
                                  ...
                                  builder: (ctx) {
                                    return AlertDialog(
                                      ...
                                      actions: loading ? [CircularProgressIndicator(color: Colors.yellow,)]  : [
                                        TextButton(
                                          onPressed: () {
                                    ...
                                    return StatefulBuilder(
                                      builder: (context, settingstate) {
                                        ...
                                        return AlertDialog(
                                          ...
                                          actions: loading ? [CircularProgressIndicator(color: Colors.yellow,)]  : [
                                          loading ? CircularProgressIndicator(color: Colors.yellow,) :  TextButton(
                                              child: const Text(
                                                'Check-In',
                                              ),
                                              onPressed: () async {
