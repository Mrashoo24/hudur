...
class AllApi {
  ...
  Future<dynamic> getCheckIn({
    ...
    var postCheckInUrl = Uri.parse(
        'https://us-east-1.aws.webhooks.mongodb-realm.com/api/client/v2.0/app/application-0-ffegf/service/getuser/incoming_webhook/getcheckin?date=$date&refid=$refId');
  ...
  Future<dynamic> getVicinity({
    ...
    var getVicinityUrl = Uri.parse(
        "https://us-east-1.aws.webhooks.mongodb-realm.com/api/client/v2.0/app/application-0-ffegf/service/getuser/incoming_webhook/getOfficeLocation?lat=$latitude&long=$longitude&refid=$refId");
  ...
  Future<void> postAttendanceReport({
    ...
    var url = Uri.parse(
        "https://us-east-1.aws.webhooks.mongodb-realm.com/api/client/v2.0/app/application-0-ffegf/service/hudur/incoming_webhook/postAttendanceReport");
    var response = await http.post(
      url,
      body: {
        'empid': empId,
